...
public class MyStepdefsTutorial {

    @Given("^I am on the tutorial screen$")
    public void iAmOnTheTutorialScreen() throws Throwable {
    ...
    public void iTapOnTheSkipButton() throws Throwable {
    ...
    public void iSeeThatANewGameScreenIsDisplayed() throws Throwable {

        DesiredCapabilities Capabilities = new DesiredCapabilities();

        AppiumDriver driver = new AppiumDriver(new URL("http://127.0.0.1:4723/wd/hub"), Capabilities);

        if (driver.findElement(By.id("com.easybrain.sudoku.android:id/title")).isDisplayed()) {

            System.out.println("New game screen is displayed");
